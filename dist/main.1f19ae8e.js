...
var div1 = dom.Create('<div>hi</div>');
var div2 = dom.Create('<div>ha ha</div>');
dom.after(test, div1);
dom.wrap(test, div2);
console.log(div1);
...
dom.on(test, 'click', function (fn) {
  return console.log('点击了');
});
var testDiv = dom.find('#siblings')[0];
...
dom.each(dom.children(t), fn = function fn(n) {
